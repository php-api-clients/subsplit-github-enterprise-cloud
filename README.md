...
[![Code Coverage](https://scrutinizer-ci.com/g/php-api-clients/github-enterprise-cloud/badges/coverage.png?b==v0.2.x)](https://scrutinizer-ci.com/g/php-api-clients/github-enterprise-cloud/?branch=v0.2.x)
...
Non-Blocking first GitHub Enterprise Cloud client, this is a read only sub split, see [`root-subsplit-github`](https://github.com/php-api-clients/github-root).
